...
### run training
os.system('~/caffe/build/tools/caffe train --solver ./res50_solver_pose.prototxt --weights ./Models/ResNet-50-model.caffemodel --gpu=1 2>&1 | tee ./trainlogs/ResNet_pose16_' )

os.system('~/caffe/build/tools/caffe train --solver ./res50_solver_orig.prototxt --weights ./Models/ResNet-50-model.caffemodel --gpu=1 2>&1 | tee ./trainlogs/ResNet_orig16_' )
